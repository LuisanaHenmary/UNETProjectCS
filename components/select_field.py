...
class SelectField:
    ...
    def set_selected(self, index) -> None:
        """Sets a new integer numeric value from a list of numbers, using its index..

            Args:
                index (int): Is the position of the number in the list."""

        self.__select_value.current(index)
